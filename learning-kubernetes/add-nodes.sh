...
VM_NAMES=("worker-3" "worker-4")
VM_IPS=("192.168.122.104/24" "192.168.122.105/24")
SSH_PUB_KEY="$(cat /home/<YOUR_USERNAME>/.ssh/id_rsa.pub)" # IMPORTANT: REPLACE WITH YOUR ACTUAL PUBLIC SSH KEY
VM_RAM=4096
VM_VCPUS=2
VM_DISK_SIZE=30 # GB
